 ...
 * File: browser-extension/src/extension-scripts/add-resolve-buttons/add-resolve-button-builder.ts
 * Purpose: Base builder class for adding Cursor buttons to PR comments
 *
